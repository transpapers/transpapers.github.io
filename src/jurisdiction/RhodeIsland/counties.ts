...
const rhodeislandCounties: { [key: string]: RhodeIslandCityOrTown } = {
    ...
    "Little Compton": {
        ...
        court: {
            ...
            city: "Little Compton",
            phone: "(401) 635-4400",
            website: "https://www.littlecomptonri.org/departments/town_clerk/index.php",
        },
        advertisementRequired: true,
        courtDoesAdvertisement: true,
    ...
    "West Warwick": {
        ...
        court: {
            ...
            city: "West Warwick",
            phone: "(401) 827-9034",
            website: "https://westwarwickri.gov/index.asp?SEC=01C4CA5C-D7DD-4E79-9865-C5D8771D07FA",
        },
        advertisementRequired: true,
        courtDoesAdvertisement: true,
