...
const rhodeislandCounties: RhodeIslandCityOrTown[] = [
  ...
  },
  {
    ...
    court: {
      ...
      city: "Bristol",
      phone: "(401) 253-7000",
      website: "https://www.bristolri.gov/391/Probate-Court",
    },
  ...
  },
  {
    ...
    court: {
      ...
      city: "Central Falls",
      phone: "(401) 727-7400",
      website: "https://www.centralfallsri.gov/city-clerk/page/probate-court-4",
    },
    advertisementRequired: true,
    courtDoesAdvertisement: true,
  ...
  },
  {
    ...
    court: {
      ...
      phone: "(401) 364-1200",
      website:
        "https://charlestownri.gov/index.asp?SEC=CD67EF22-5D8F-4CD1-8AF5-0CC375FD66C8&DE=E7387C56-049D-4A37-9C9B-B1F77BCF5580",
    },
    advertisementRequired: true,
    courtDoesAdvertisement: true,
    ...
    publications: [
      {
        name: "Westerly Sun",
        website:
          "https://www.woonsocketcall.com/site/contact.htmlhttps://www.thewesterlysun.com/site/contact.html",
      },
    ],
    filingCost: "$34.00",
  },
  ...
  },
  {
    ...
    court: {
      ...
      phone: "(401) 780-3197",
      website:
        "https://www.cranstonri.gov/departments/city-clerk-records-and-licenses/cranston-probate-court/",
    },
    advertisementRequired: false,
    courtDoesAdvertisement: false,
  ...
  },
  {
    ...
    court: {
      ...
      phone: "(401) 423-7282",
      website:
        "https://www.jamestownri.gov/town-departments/clerk/probate-court-test",
    },
    advertisementRequired: false,
    courtDoesAdvertisement: false,
  ...
  },
  {
    ...
    court: {
      ...
      phone: "(401) 635-4400",
      website:
        "https://www.littlecomptonri.org/departments/town_clerk/index.php",
    },
    advertisementRequired: true,
    courtDoesAdvertisement: true,
  ...
  },
  {
    ...
    court: {
      ...
      phone: "(401) 845-5349",
      website:
        "https://www.cityofnewport.com/city-hall/departments/city-clerk/probate-court",
    },
    advertisementRequired: true,
    courtDoesAdvertisement: true,
  ...
  },
  {
    ...
    court: {
      ...
      website: "https://www.nsmithfieldri.gov/170/Town-Clerk",
    },
    advertisementRequired: true,
    courtDoesAdvertisement: true,
  ...
  },
  {
    ...
    court: {
      ...
      website:
        "https://www.smithfieldri.gov/departments/town-clerk/probate-court-information",
    },
    advertisementRequired: false,
    courtDoesAdvertisement: false,
  ...
  },
  {
    ...
    court: {
      ...
      website:
        "https://www.townofwarren-ri.gov/town_government/boards_and_commissions/probate_judge.php",
    },
    advertisementRequired: true,
    courtDoesAdvertisement: true,
  ...
  },
  {
    ...
    court: {
      ...
      phone: "(401) 827-9034",
      website:
        "https://westwarwickri.gov/index.asp?SEC=01C4CA5C-D7DD-4E79-9865-C5D8771D07FA",
    },
    advertisementRequired: true,
    courtDoesAdvertisement: true,
  ...
  },
  {
    ...
    court: {
      ...
      city: "Woonsocket",
      phone: "(401) 767-9248",
      website: "https://www.woonsocketri.gov/city-clerk",
    },
    advertisementRequired: true,
    courtDoesAdvertisement: true,
