...
const michiganCounties: { [key: string]: County } = {
  ...
  Allegan: {
    court: {
      ...
      circuit: '48th',
      phone: '(269) 673-0534',
      website: 'https://www.allegancounty.org/courts-law-enforcement/family-court',
    },
    fingerprintLocations: [
      {
  ...
  Antrim: {
    court: {
      ...
      circuit: '13th',
      phone: '(231) 533-6353',
      website: 'https://www.antrimcounty.org/departments___services_/courts/probate_court_and_family_division/name_change_petition.php',
    },
    fingerprintLocations: [
      {
        address: '107 Grove St, Bellaire, MI 49615',
        name: 'Antrim County Sheriff',
        website: 'https://www.antrimcounty.org/departments___services_/sheriff/index.php',
      },
    ],
    publications: [
      {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'https://keweenawbay.org/government/departments/county-sheriff/',
      },
    ],
    publications: [
      {
  ...
  Barry: {
    court: {
      ...
      circuit: '5th',
      phone: '(269) 945-1390',
      website: 'https://www.barrycounty.org/courts_and_law_enforcement/family_court/change_of_name.php',
    },
    fingerprintLocations: [
      {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'https://www.baycounty-mi.gov/Clerk/ConcealedPistolPermitsCCW.aspx',
      },
    ],
    publications: [
      {
  ...
  Benzie: {
    court: {
      ...
      circuit: '19th',
      phone: '(231) 882-0023',
      website: 'https://www.benzieco.net/government/19th_judicial_circuit_court/index.php',
    },
    fingerprintLocations: [
      {
        address: '505 S Michigan Ave, Beulah, MI 49617',
        name: 'Benzie County Sheriff',
        website: 'https://www.benzieco.net/government/county_sheriff_s_office/services/finger_printing_services.php',
      },
    ],
    publications: [
      {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'http://www.coldwater.org/DocumentCenter/View/227/Public-Safety-Fee-Schedule-PDF?bidId=',
      },
    ],
    publications: [
      {
  ...
  Calhoun: {
    court: {
      ...
      circuit: '37th',
      phone: '(269) 969-6518',
      website: 'https://www.calhouncountymi.gov/departments/courts/circuit_court/name_changes.php',
    },
    fingerprintLocations: [
      {
        address: '161 Michigan Ave, Battle Creek, MI 49014',
        name: 'Calhoun County Sheriff',
        website: 'https://www.calhouncountymi.gov/departments/sheriffs_office/records_division.php',
      },
    ],
    publications: [
      {
  ...
  Charlevoix: {
    court: {
      ...
      circuit: '33rd',
      phone: '(231) 547-7277',
      website: 'https://www.charlevoixcounty.org/the_7th_probate_court/name_change.php',
    },
    fingerprintLocations: [
      {
        address: '1000 Grant St, Charlevoix, MI 49720',
        name: 'Charlevoix County Sheriff',
        website: 'https://www.charlevoixcounty.org/charlevoix_county_sheriff/index.php',
      },
    ],
    publications: [
      {
  ...
  Cheboygan: {
    court: {
      ...
      circuit: '53rd',
      phone: '(231) 627-8823',
      website: 'https://www.cheboygancounty.net/courts-law-enforcement/probate-family-court/',
    },
    fingerprintLocations: [
      {
        address: '870 S Main Street, Cheboygan, MI  49721',
        name: 'Cheboygan County Sheriff',
        website: 'https://www.cheboygancounty.net/courts-law-enforcement/sheriffs-department/',
      },
    ],
    publications: [
      {
  ...
  Clinton: {
    court: {
      ...
      circuit: '29th',
      phone: '(989) 224-5140',
      website: 'https://www.clinton-county.org/FormCenter/Friend-of-the-Court-11/Name-Change-Request-Form-137',
    },
    fingerprintLocations: [
      {
  ...
  Crawford: {
    court: {
      ...
      circuit: '46th',
      phone: '(989) 344-3260 ',
      website: 'https://lookup.circuit46.org/Crawford/web%20brochures/c46c_Name_Change.pdf',
    },
    fingerprintLocations: [
      {
  ...
  Dickinson: {
    court: {
      ...
      circuit: '41st',
      phone: '(906) 774-1555',
      website: 'https://www.dickinsoncountymi.gov/government/county_departments/courts.php',
    },
    fingerprintLocations: [
      {
  ...
  Eaton: {
    court: {
      ...
      circuit: '56th',
      phone: '(517) 543-7500',
      website: 'https://www.eatoncounty.org/DocumentCenter/View/851/Name-Change-PDF',
    },
    fingerprintLocations: [
      {
  ...
  Gogebic: {
    court: {
      ...
      circuit: '32nd',
      phone: '(906) 663-4611',
      website: 'https://www.gogebiccountymi.gov/government/courts/circuit_court/index.php',
    },
    fingerprintLocations: [
      {
        address: '100 W Iron St, Bessemer, MI 49911',
        name: 'Gogebic County Sheriff',
        website: 'https://www.gogebiccountymi.gov/government/county_offices/sheriff_s_office.php',
      },
    ],
    publications: [
      {
  ...
  Hillsdale: {
    court: {
      ...
      circuit: '1st',
      phone: '(517) 437-4643',
      website: 'https://www.co.hillsdale.mi.us/index.php/tm-courts/tsm-crt-probate',
    },
    fingerprintLocations: [
      {
        address: '165 Fayette St W, Hillsdale, MI 49242',
        name: 'Hillsdale County Sheriff',
        website: 'https://www.co.hillsdale.mi.us/index.php/m-hcso-services/m-hcso-fingerprint',
      },
    ],
    publications: [
      {
  ...
  Houghton: {
    court: {
      ...
      circuit: '12th',
      phone: '(906) 482-3120',
      website: 'https://www.houghtoncounty.net/directory-probate-family-court.php',
    },
    fingerprintLocations: [
      {
  ...
  Ingham: {
    court: {
      ...
      circuit: '30th',
      phone: '(517) 483-6313',
      website: 'https://cc.ingham.org/courts_and_sheriff/circuit_court/name_change.php',
    },
    fingerprintLocations: [
      {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'https://ioniacounty.org/public-safety/sheriff/sheriff-records/',
      },
    ],
    publications: [
      {
  ...
  Iron: {
    court: {
      ...
      circuit: '41st',
      phone: '(906) 875-3121',
      website: 'https://www.ironcounty.net/government/departments/justice-court/request-to-court',
    },
    fingerprintLocations: [
      {
  ...
  Isabella: {
    court: {
      ...
      circuit: '21st',
      phone: '(989) 317-4097',
      website: 'https://www.isabellacounty.org/law-justice/trial-court/divisions-services/probate-division/',
    },
    fingerprintLocations: [
      {
  ...
  Jackson: {
    court: {
      ...
      circuit: '4th',
      phone: '(517) 788-4290',
      website: 'https://www.co.jackson.mi.us/DocumentCenter/View/274/Name-Change-PDF',
    },
    fingerprintLocations: [
      {
  ...
  Kalamazoo: {
    court: {
      ...
      circuit: '9th',
      phone: '(269) 383-8837',
      website: 'https://www.kalcounty.com/courts/circuit/name_change_instructions.htm',
    },
    fingerprintLocations: [
      {
  ...
  Kalkaska: {
    court: {
      ...
      circuit: '46th',
      phone: '(231) 258-9031',
      website: 'https://www.kalkaskacounty.net/government/michigan_courts/index.php',
    },
    fingerprintLocations: [
      {
        address: '605 N Birch St, Kalkaska, MI 49646',
        name: 'Kalkaska County Sheriff',
        website: 'https://kalkaskasheriff.net/divisions/records/fingerprints.php',
      },
    ],
    publications: [
      {
        name: 'The Antrim Review',
        website: 'https://www.antrimreview.net/?fbclid=IwAR0gUh3fuEySYqmdi0V3zmVJSJuwHOpGQGjcwoHb6DLgm6Fc7zM8eBi4Spg',
      },
    ],
  },
  Kent: {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'http://lakecounty-michigan.com/PublicSafety/SheriffsOffice.aspx',
      },
    ],
    publications: [
      {
  ...
  Lapeer: {
    court: {
      ...
      circuit: '40th',
      phone: '(810) 667-0358',
      website: 'https://www.lapeercountymi.gov/courts/40th_circuit_court/index.php',
    },
    fingerprintLocations: [
      {
  ...
  Mackinac: {
    court: {
      ...
      circuit: '11th',
      phone: '(906) 643-7303',
      website: 'https://www.mackinaccounty.net/departments/courts/probate-court/name-changes/',
    },
    fingerprintLocations: [
      {
        address: '100 S Marley St, St Ignace, MI 49781',
    ...
    publications: [
      {
        ...
        website: 'https://www.shorelinemedia.net/ludington_daily_news/site/contact.html',
      },
    ],
  },
  Mecosta: {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'https://cms9files.revize.com/mecostacountymi/community%20corrections/LIVESCAN_HANDOUT_2019-01.pdf',
      },
    ],
    publications: [
      {
  ...
  Menominee: {
    court: {
      ...
      circuit: '41st',
      phone: '(906) 863-2634',
      website: 'https://www.menomineecounty.com/departments/?department=4ebc313f7a83',
    },
    fingerprintLocations: [
      {
        address: '831 10th Ave, Menominee, MI 49858',
        name: 'Menominee County Sheriff',
        website: 'https://www.menomineecounty.com/departments/?department=85bf1f570592&subdepartment=1e942dd36f19',
      },
    ],
    publications: [
      {
  ...
  Midland: {
    court: {
      ...
      circuit: '42nd',
      phone: '(989) 832-6735',
      website: 'https://www.co.midland.mi.us/Courts/ProbateandJuvenileCourt/ProbateCourt/AdoptionsandNameChanges.aspx',
    },
    fingerprintLocations: [
      {
  ...
  Missaukee: {
    court: {
      ...
      circuit: '28th',
      phone: '(231) 839-4967',
      website: 'https://www.missaukee.org/government/courts___legal/28th_circuit_court/circuit_court_family_division.php',
    },
    fingerprintLocations: [
      {
        address: '110 S Pine St, Lake City, MI 49651',
        name: 'Missaukee County Sheriff',
        website: 'https://www.missaukee.org/departments/sheriff/fingerprinting.php',
      },
    ],
    publications: [
      {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'https://www.newaygocountymi.gov/departments/county-sherrif/administrative-support/',
      },
    ],
    publications: [
      {
  ...
  Oakland: {
    court: {
      ...
      circuit: '6th',
      phone: '(248) 858-0344',
      website: 'https://www.oakgov.com/clerkrod/court-records/Pages/legal-name-change.aspx',
    },
    fingerprintLocations: [
      {
        address: '1200 N Telegraph Road Building #38E, Pontiac, MI 48341',
        name: 'Oakland County Sheriff',
        website: 'https://www.oakgov.com/sheriff/Corrections-Courts/Pages/Records-Unit.aspx',
      },
    ],
    publications: [
      {
  ...
  Oceana: {
    court: {
      ...
      circuit: '27th',
      phone: '(231) 873-3666',
      website: 'https://oceana.mi.us/government/courts/probate-court/name-changes/',
    },
    fingerprintLocations: [
      {
    ...
    publications: [
      {
        ...
        website: 'https://www.shorelinemedia.net/oceanas_herald_journal/site/contact.html',
      },
    ],
  },
  Ogemaw: {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'https://www.ocmi.us/wp-content/uploads/Sheriff-Correctional-FingerprintInfo.pdf',
      },
    ],
    publications: [
      {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'https://ontonagoncounty.org/county-offices/sheriff-department/',
      },
    ],
    publications: [
      {
  ...
  Osceola: {
    court: {
      ...
      circuit: '49th',
      phone: '(231) 832-6124',
      website: 'https://cms4files.revize.com/osceolami/document_center/Probate%20Court/Name%20Change%20packet%203.31.22.pdf',
    },
    fingerprintLocations: [
      {
        address: '325 W Upton Ave, Reed City, MI 49677',
        name: 'Osceola County Sheriff',
        website: 'https://www.osceola-county.org/residents/county_departments/sheriff_1/index.php',
      },
    ],
    publications: [
      {
  ...
  Otsego: {
    court: {
      ...
      circuit: '46th',
      phone: '(989) 731-0204',
      website: 'https://www.otsegocountymi.gov/DocumentCenter/View/1313/Name-Change-Packet-PDF',
    },
    fingerprintLocations: [
      {
    ...
    fingerprintLocations: [
      {
        ...
        website: 'http://www.roscommoncounty.net/328/Frequently-Asked-Questions',
      },
    ],
    publications: [
      {
  ...
  'St. Clair': {
    court: {
      ...
      circuit: '31st',
      phone: '(810) 985-2200',
      website: 'https://www.stclaircounty.org//offices/prosecuting_attorney/Directions.aspx',
    },
    fingerprintLocations: [
      {
        address: '1170 Michigan Rd, Port Huron, MI 48060',
        name: 'St. Clair County Sheriff',
        website: 'https://www.stclaircounty.org/offices/sheriff/service_bureau.aspx',
      },
    ],
    publications: [
      {
  ...
  'St. Joseph': {
    court: {
      ...
      circuit: '45th',
      phone: '(269) 467-5531',
      website: 'https://www.stjosephcountymi.org/government/courts-law-enforcement/county-clerk-45th-circuit-court-division/legal-name-change',
    },
    fingerprintLocations: [
      {
  ...
  Sanilac: {
    court: {
      ...
      circuit: '24th',
      phone: '810-648-3212',
      website: 'https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwifrIPsjon9AhWBnWoFHRaBCbwQFnoECBAQAQ&url=https%3A%2F%2Fwww.sanilaccounty.net%2FHandlers%2FFile.ashx%3FID%3D12004&usg=AOvVaw0611sDWMrHOnYKPe_cfQjh',
    },
    fingerprintLocations: [
      {
  ...
  Schoolcraft: {
    court: {
      ...
      circuit: '11th',
      phone: '(906) 341-3655',
      website: 'https://www.schoolcraftcounty.net/government/courts-of-schoolcraft-county/11th-judicial-court-judge',
    },
    fingerprintLocations: [
      {
        address: '300 Main St, Manistique, MI 49854',
        name: 'Schoolcraft County Sheriff',
        website: 'http://www.schoolcraftcounty.net/government/elected-officials/sheriff',
      },
    ],
    publications: [
      {
  ...
  'Van Buren': {
    court: {
      ...
      circuit: '36th',
      phone: '(269) 657-8200',
      website: 'https://www.vanburencountymi.gov/DocumentCenter/View/2085/Name-Change-for-an-Adult-NC-case-type',
    },
    fingerprintLocations: [
      {
        address: '43255 60th Ave, Paw Paw, MI 49079',
        name: 'Michigan State Police',
        website: 'https://www.vanburencountymi.gov/DocumentCenter/View/2085/Name-Change-for-an-Adult-NC-case-type?bidId=',
      },
    ],
    publications: [
      {
