 ...
 */
  export const adultNameSexPetitionOregonMap: Formfill[] = [
    ...
    {
        text: (applicant) => isEmptyName(applicant.chosenName) ? fullName(applicant.legalName) : "",
        loc: { x: 445, y: 770 },
    },
    {
        text: (applicant) => isEmptyName(applicant.chosenName) ? applicant.chosenName?.first : "",
        loc: { x: 386, y: 838 },
    },
    {
        text: (applicant) => isEmptyName(applicant.chosenName) ? applicant.chosenName?.middle : "",
        loc: { x: 740, y: 838 },
    },
    {
        text: (applicant) => isEmptyName(applicant.chosenName) ? applicant.chosenName?.last : "",
        loc: { x: 1145, y: 838 },
    },
    {
    ...
    {
        text: (applicant) => isEmptyName(applicant.birthName) ? "" : fullName(applicant.birthName),
        loc: { x: 305, y: 1675 },
    },
    /** needs to be a change of sex specifically as well as .doNotPublish for the next 2.*/
    {
 ...
 */
    export const feeWaiverOregonMap: Formfill[] = [
        ...
        {
            text: (applicant) => (isMinor(applicant) ? fullName(applicant.representativeName) : 
                fullName(applicant.legalName)),
                loc: { x: 188, y: 355 },
        },
        {
            text: (applicant) => (isMinor(applicant) ? applicant.representativeName?.first : 
                applicant.legalName?.first),
                loc: { x: 490, y: 602 },
        },
        {
            text: (applicant) => (isMinor(applicant) ? applicant.representativeName?.middle : 
                applicant.legalName?.middle),
                loc: { x: 870, y: 602 },
        },
        {
            text: (applicant) => (isMinor(applicant) ? applicant.representativeName?.last : 
