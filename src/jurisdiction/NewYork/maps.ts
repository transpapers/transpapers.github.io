 ...
 */
  export const adultNameSexPetitionMap: Formfill[] = [
    ...
    {
        select: (applicant) => applicant.doNotPublish,
...
/** Radio button for "Has you name changed" should go here */
        {
            text: (applicant) => fullName(applicant.legalName),
            field: "If Yes print your former name exactly as it appears on your present license or nondriver ID Identification card",
        },
        {
            /** need additional checks for if changing sex */
            text: () => "New sex designation for a legal sex designation change.",
            field: "OTHER CHANGE What is the change and the reason for it new license class wrong date of birth etc Et cetera",
        },
        {
            text: (applicant) => applicant.streetAddress,
            field: "ADDRESS WHERE YOU LIVE REQUIRED IF DIFFERENT FROM ADDRESS FOR MAIL DO NOT GIVE PO Post OfficeBOX THIS ADDRESS WILL APPEAR ON YOUR ENHANCED REAL ID IDENTITY DOCUMENT",
        },
        {
