...
export const genderChangeAdultMap: Formfill[] = [
  ...
  (applicant) => ({
    text: formatContactInfo(
      applicant,
      cf.ResidentCityAndLocalityAndStateAndZip,
    ),
...
export const genderChangeMinorMap: Formfill[] = [
  ...
  (applicant) => ({
    text: applicant.streetEqualsMail 
      ? formatContactInfo(applicant, cf.ResidentFullAddress) 
      : formatContactInfo(applicant, cf.MailFullAddress),
    loc: { page: 7, x: 215, y: 646 },
  }),
  (applicant) => ({
    text: applicant.parentsAreOkay 
      ? formatContactInfo(applicant, cf.MailFullAddress) : "",
    loc: { page: 7, x: 215, y: 765 },
  }),
];
...
export const feeWaiverMap: Formfill[] = [
  ...
  (applicant) => ({
    ...
    fieldName: "Mailing  Dirección Postal 2",
  }),
  (applicant) => ({
    text: applicant.phone,
...
export const birthCertNameCorrectionMap: Formfill[] = [
  ...
  (applicant) => ({
    text:
      isMinor(applicant) && applicant.parentsAreOkay ? applicant.homeAddress?.city : "",
    fieldName: "City",
  }),
  (applicant) => ({
    text:
