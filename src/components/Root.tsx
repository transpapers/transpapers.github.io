...
export default function Root() {
  ...
  return (
    <main>
      <section>
        <p>
          <strong>In the news:</strong> Transpapers has been covered in{" "}
          <a href="https://xtramagazine.com/power/identity/transpapers-michigan-259355">
            Xtra Magazine
          </a>{" "}
          (17 November 2023) and{" "}
          <a href="https://pridesource.com/article/transpapers-a-free-michigan-made-resource-for-trans-empowerment-across-the-u-s">
            PrideSource
          </a>{" "}
          (27 December 2023).
        </p>
        ...
        <p>
          ...
          to filing them. The forms will be prefilled using the information you
          entered.
        </p>
        <p>
          <strong>Is it safe to enter my personal data?</strong> Yes. Everything
          happens client-side; that is to say, on your computer. Your personal
          data will never be collected, retained, or in any way transmitted over
          the Internet. The especially privacy-conscious can even{" "}
          ...
          <a href="https://transpapers.lgbt">https://transpapers.lgbt</a>; other
          addresses may not be secure.)
        </p>
        <p>
          <strong>My state isn&apos;t listed.</strong> Transpapers is developed
