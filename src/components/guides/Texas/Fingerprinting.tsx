  ...
  return (
    <section key="Texas-Fingerprinting">
      ...
      <p>
        ...
        paperwork, there are a variety of options to do this across Texas. We
        have compiled a map of these locations{" "}
        <a href="https://www.google.com/maps/d/u/1/edit?mid=1TKgi_yLa7CydkGgBppyiyy8EFsyhbYg&usp=sharing">
          here
        </a>{" "}
        and separated them into a few categories. Blue pins are law enforcement
        offices, yellow pins are also law enforcement offices but they require
        you to have a fingerprint card ready for them to fill out, green pins
        are private businesses. If you choose a yellow pin you can buy either a
        Texas DPS card or an FBI card (FD-258) from many places including
        Amazon, Identogo, or an office supply store. It does not matter which of
        the two types you buy. Each pin also contains more specific information
        about each location such as hours, prices, or contact info.
      ...
      <p>
        ...
        Adult Legal Name Change” (CR-65). This will tell you what information is
        required on the card and where. Do <strong>not</strong> send any cards
