  ...
  return (
    <section key="TX-InitialForms">
      ...
      <p>
        ...
        {age && age < 18 && (
          <>
            If there is no hearing they may ask for your petitioner to file an
            “Information on Suit Affecting the Family Relationship (Excluding
            Adoptions)” (VS-165) form in addition to everything else. In that
            case they should use the one we provided. Otherwise that form will
        ...
        {age && age < 18 ? "a Child”" : "an Adult”"} in the mail several weeks
        later. If this happens you can skip the “Hearing” section.
      </p>
      ...
      <p>
        ...
        <a href="https://efiletx.tylertech.cloud/OfsEfsp/ui/landing">link</a>.
        Help with E-filing is available as a guide{" "}
        <a href="https://selfhelp.efiletexas.gov/srl">here</a> or as a series of
        step by step videos from the Trans Legal Aid Clinic{" "}
        <a href="https://www.youtube.com/watch?v=2HODDeFNztg">here</a>.
      </p>
      ...
      <p>
        For in-person filing the clerk will need all of the completed gender
        change forms,
        {age && age < 18
        ...
        {hasCriminalRecord ? (
          <>
            If you meet the requirements of the criminal history questions you
            also need to provide the applicable documents listed on the
            checksheet at the end of the petition form.
          </>
        ) : (
          ""
        )}
        Once everything has been filed they will process the documents and send
        out a notice either by email or snail mail several weeks later. If this
        notice has not been received after 4 months of waiting
        {age && age < 18 ? " your petitioner" : " you"} can call the Travis
        county law library at (512) 854-8677 to check up on the case. A hearing
        will be very unlikely, if one is scheduled that usually means that there
        was a paperwork error or something related to criminal history.
      </p>

      <p>
        When the court reaches out with notice
        {age && age < 18 ? " your petitioner" : " you"} will need to contact the
        district clerk and order one certified copy of the signed Order
