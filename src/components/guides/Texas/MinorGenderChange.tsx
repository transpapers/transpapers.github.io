  ...
  return (
    <section key="Texas-Minor-Gender-Change">
      ...
      <p>
        ...
        until you are 18 to do the adult process. You can find legal help in 
        the “Resources” section if needed.
      </p>
      ...
      {hasCriminalRecord ? (
        <>
          {" "}4H, and 4I. For 4H they are talking about using a “Sex 
          Offender Update Form” (CR-32) to notify law enforcement.{" "}
        </>
      ) : (" and 4I. ")}
      Then your petitioner and any potential co-petitioner will need to sign in 
      section 7. They will also need to fill out sections 8 or 9 as needed. 
      Signing in sections 8 or 9 is under threat of perjury, make sure the 
      information on the form is accurate <strong>before</strong> signing. Section 
      10 is a checklist for additional documents, we will cover the first 3 items 
      later in this section and in the next section.
      </p>

      <p>
        The “Final Order to Change the Name and Sex/Gender Identifier of a Minor” 
        (TC-FM-GI3-200) is the form that the judge will sign and give back if they 
        approve the change. They want it to be pre-filled so your petitioner will 
        need to fill out any blanks in section 1. For any checkboxes about being 
        present or not present check “not present” unless there was a hearing that 
        said person attended. From there they should fill out any blanks in sections 
        4C through 4H with the same information as the petition. The petitioner and 
        any co-petitioners should then sign and fill in their contact information 
        in section 6 in the appropriate spots.
      </p>
    </section>
  );
}
