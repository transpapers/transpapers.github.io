...
function TexasGenderChangeLetterGuide() {
  return (
    <section key="Texas-Gender-Change-Letter">
      <h3>Gender Change Letter (TX)</h3>
      <p>
        You will need a letter from a doctor to demonstrate that you are
        receiving “the appropriate clinical treatment for transitioning”. This
        does <strong>not</strong> mean any specific medical treatments or
        surgeries. We have included a template letter for you to show your
...
export default TexasGenderChangeLetterGuide;
