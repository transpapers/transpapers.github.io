...
function TexasMinorNameParentsPetitionGuide({
  person,
}: {
  ...
  return (
    <section key="Texas-FM-NCC1-100">
      <h3>
        Petition to Change the Name of a Child or Children (TX, FM-NCC1-100)
      </h3>
      <p>
        ...
        contested hearing which is beyond the scope of this guide, if this
        happens your supportive parent will need a lawyer or you will need to
        wait until you are 18. See the “Resources” section below for help
      ...
      <p>
        ...
        {hasCriminalRecord ? (
          <>
            ...
            with the Texas DPS. A parent should check the applicable box in
            section 4G as it applies to you. For 4G they are talking about using
      ...
      <p>
        Both parents should fill out section 4J in their own words then sign in
        section 6. Sections 7 and 8 have your parents sign under penalty of
        perjury meaning it is a crime to lie on this form so they should double
        check that everything is correct <strong>before</strong> signing.
        Finally they should fill out any blanks left in sections 7 and 8, before
        they sign/date each section.
      </p>
    </section>
  );
}
