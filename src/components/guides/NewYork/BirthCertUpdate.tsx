    ...
    <section key="NewYork-BC-Update">
      ...
      {age && age < 18 ? (
        <>
          ...
          <p>
            For the self-attestation form have a parent/guardian fill in any
        ...
        <>
          <p>
            ...
            Signature”. The fee is $40 + (the number of requested copies x $15).
            For one copy the fee should be $55, fill in the fee information on
            page 4 accordingly.
          </p>
      ...
      <p>
        New York City allows for either an in-person appointment or a mail in.
        If you opt for mailing, have a check or money order made out to the “NYC
        Department of Health and Mental Hygiene” for the total amount as listed
        on page 4.
        {age && age < 18
      ...
      <p>
        The New York State Vital Records department does mail in updates only.
        Have a $30 check or money order made out to the “NYS Department of
        Health”. Then place the payment, certified copy of your court order,
        {age && age < 17
          ? " DOH-5306 form, notarized DOH-5304 form, "
          : " DOH-5305 form, notarized DOH-5303 form, "}
        and a certified copy of your birth certificate into an envelope and mail
        it to:
      </p>
