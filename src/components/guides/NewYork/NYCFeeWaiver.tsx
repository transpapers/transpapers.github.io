...
function NYCFeeWaiverGuide({ person }: { person: Partial<Person> }) {
  const { age } = person;
  ...
  return (
    <section key="NYC-Fee-Waiver">
      ...
      <p>
        ...
        petition to the court. In New York City the filing fee is $65. Courts will 
        ...
        you may file the request at your discretion; the worst they can do is deny 
        it.
      </p>
