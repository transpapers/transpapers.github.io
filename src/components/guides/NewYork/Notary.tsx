    ...
    <section key="NewYork-Notary">
      ...
      {birthJurisdiction?.name === "New York" ? (
        <p>
          ...
          option if you were born in New York City. Appointments can be made at
          this{" "}
      ...
      {age && age < 18 ? (
        ...
        <p>
          You will need a notary to witness your signature and provide their
          own. Notaries can be found in court buildings, banks, some{" "}
          <a href="https://www.theupsstore.com/tools/find-a-store">
            UPS locations
          </a>
          , or <a href="https://www.notarize.com/">online</a>. You will be
          charged a fee for this required service. Once you have met with one to
          get the required signature and stamp you are ready to file.
        </p>
      )}
    </section>
  );
