    ...
    <section key="Oregon-Minor-Petition">
      ...
      <p>
        {isChangingLegalName ? (
            ...
            petitioner should fill out why this is in your best interest on
        ...
        The “General Judgement” is on pages 6 and 7 should already be filled 
        out, your petitioner can file it with the petition.
      </p>
    </section>
  );
}
