...
function OregonBirthCertUpdateGuide({ person }: { person: Partial<Person> }) {
  const { age, parentsAreOkay, birthJurisdictionName, residentJurisdictionName } =
    person;
  ...
  return (
    <section key="Oregon-BC-Update">
      ...
      {age && age < 18 ? (
        <>
          ...
          <p>
            ...
            <a href="https://www.onpointcu.com/faq/do-you-offer-notary-services/">
                OnPoint Credit Unions
            </a>
            , some{" "}
          ...
          <p>
            ...
            parent is filling this out and their name does not match the one
            on your birth certificate they will need to attach documentation
            of the change (e.g. marriage certificate, divorce certificate,
            court order, etc…) <strong>photocopies only</strong>.
            {parentsAreOkay
                ? " "
                : " Legal guardians need to provide proof of guardianship. "}
            If they do not have a driver&apos;s license or state ID the
            “Oregon Vital Records Acceptable Proofs of Identity” we included
            has a list of acceptable alternatives to photocopy. For payment
            they take either checks or money orders made out to “Oregon
            Vital Records”. Mail the application to the following address:
          </p>
        </>
      ) : (
        <>
          ...
          <p>
            After your form is notarized you will need a large envelope, a
            copy of your court order, a photocopy of your ID (both sides),
            and payment. If you do not have a driver&apos;s license or state
            ID the “Oregon Vital Records Acceptable Proofs of Identity” we
            included has a list of acceptable alternatives to photocopy. For
            payment they take either checks or money orders made out to
            “Oregon Vital Records”. Mail the application to the following
            address:
          </p>
        </>
      )}
      ...
      <p>
        Alternatively the envelope can be placed in a dropbox at 800 NE
        Oregon St, Portland. It may take up to six months to process once
        the letter is sent.
        {age && age < 18 ? (
          <>
            {birthJurisdictionName && birthJurisdictionName === "Oregon" &&
            residentJurisdictionName && residentJurisdictionName === "Oregon" ? (
              <> 
                ...
                Security using those documents. Any mention of the court order 
                in those guides means the correspondence letter for you.
              </>
            ) : ("")}
          </>
        ) : (
