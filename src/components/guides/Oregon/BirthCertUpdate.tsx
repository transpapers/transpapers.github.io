      ...
      {age && age < 18 ? (
        <>
          ...
          <p>
            ...
            , or <a href="https://www.notarize.com/">online</a>. There may be a
            fee for this required service.
          </p>

          <p>
            After the form is notarized your parent/guardian will need a large
            envelope,
            {birthJurisdiction && birthJurisdiction === "Oregon"
              ? " "
              : " a copy of your court order, "}
            a photocopy of their ID (both sides), and payment. If your parent is
            filling this out and their name does not match the one on your birth
            ...
            Vital Records Acceptable Proofs of Identity” we included has a list
            of acceptable alternatives to photocopy. For payment they take
            either checks or money orders made out to “Oregon Vital Records”.
        ...
        <>
          <p>
            The form used to update a birth certificate is the “Application to
            Change the Name and/or Sex on a Record of Live Birth to Support
            Gender Identity”. If your mailing address is different from your
            listed address put it in number 3. You will then need to fill out
            item 15, specifically the number of copies that you want and what
            form you want them in. Do <strong>not</strong> sign/date the form
          ...
          <p>
            After your form is notarized you will need a large envelope, a copy
            of your court order, a photocopy of your ID (both sides), and
            payment. If you do not have a driver&apos;s license or state ID the
            “Oregon Vital Records Acceptable Proofs of Identity” we included has
            a list of acceptable alternatives to photocopy. For payment they
            take either checks or money orders made out to “Oregon Vital
            Records”. Mail the application to the following address:
          </p>
        </>
      )}
