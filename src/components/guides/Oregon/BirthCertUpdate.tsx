...
function OregonBirthCertUpdateGuide({ person }: { person: Partial<Person> }) {
  ...
  return (
    <section key="Oregon-BC-Update">
      ...
      {birthJurisdiction && residentJurisdiction ? (
        <>
          {age && age < 18 ? (
            <>
              <p>
                {birthJurisdiction.name === "Oregon"
          ...
          <p>
            ...
            {age && age < 18 ? (
              <>
                {birthJurisdiction.name === "Oregon" &&
                residentJurisdiction.name === "Oregon"
        ...
        <p>
          Could not generate, birthJurisdiction and/or residentJurisdiction
          missing.
        </p>
      )}
    </section>
