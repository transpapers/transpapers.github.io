        ...
        <>
          {isChangingLegalSex ? (
            <p>
              ...
              {residentLocality.court.address}. However the petition can be
              filed at any other Oregon circuit court as well. We have provided
              a map of all Oregon circuit courts{" "}
              <a href="https://www.google.com/maps/d/u/0/viewer?mid=11l4y7lcd51YLjlNXl2Qcbb4Fmg_1aaI&hl=en&ll=44.22287483137777%2C-120.8304999&z=7">
                here
              </a>{" "}
              and if another court is more safe/convenient then file there
              instead. Every circuit court in Oregon has their info on this{" "}
              <a href="https://www.courts.oregon.gov/courts/Pages/default.aspx">
                website
              </a>
              . Some courts accept filing by mail or even online, the web link
              we provided will have the details for those. Make sure to fill in
              the “County” field at the top of every page on all of the forms
              with the name of whatever county they will be filed at. If the
              ...
              forms. To find out what payment methods the court accepts check
              the link or call them.
            </p>
          ) : (
            <p>
              {residentLocality.name === "Umatilla"
              ...
              <a href={residentLocality.court.website}>
                {residentLocality.court.website}
              </a>
              . That link may also show what filing methods the court accepts,
          ...
          {age && age < 18 ? (
            <p>
              ...
              has been sent your petitioner can fill out the table in the
              “Declaration of Notice” form with everyone they contacted. At that
              point they can sign it and send it to the court, then the court
              will likely make a judgment without a hearing and mail the
              results. If so skip the “Court Hearing” section. Assuming there
              isn&apos;t a hearing you will need to wait for the “General
              Judgement”, which we will call the court order, to arrive. Once it
              does your petitioner will also need to order 2 or 3 certified
              copies of the court order for use later in this process as some
              places will not return them. Keep the original in a safe place. If
              there is a hearing your petitioner will recieve a court date
              instead and we recommend getting help from a lawyer or our
              “Resources” section.
            </p>
          ) : (
            <p>
              Once you have filed, the court will likely make a judgment without
              a hearing and will mail you the results. If so skip the “Court
              ...
              though. Assuming there isn&apos;t one you will need to wait for
              the “General Judgement”, which we will call the court order, to
              arrive. Once it does you will need to order 2 or 3 certified
              copies of the court order for use later in the process as some
              places will not return them. Keep the original in a safe place. If
              there is a hearing you will recieve a court date instead.
            </p>
          )}
        </>
      ) : (
