    ...
    <section key="OR-InitialForms">
      ...
      {isChangingLegalSex && isChangingLegalSex === true ? (
        <p>
          ...
          have provided a map of all Oregon circuit courts{" "}
          ...
          &lquot;County&rquot; field at the top of every page on all of the
      ...
      <p>
        ...
        We recommend that you direct any of those questions to the court’s legal
      ...
      {age && age < 18 ? (
        <p>
          ...
          parents or legal guardians regardless of custody, the only exceptions
          being if the minor has not lived with them and they haven’t given
          support (or tried to). You do <strong>not</strong> need their consent,
          ...
          fill out the table in the &lquot;Declaration of Notice&rquot; form
          ...
          hearing and mail the results. If so skip the &lquot;Court
          Hearing&rquot; section. Assuming there isn&apos;t a hearing you will
          need to wait for the &lquot;General Judgement&rquot;, which we will
          ...
          lawyer or our &lquot;Resources&rquot; section.
        </p>
      ) : (
        <p>
          Once you have filed, the court will likely make a judgment without a
          hearing and will mail you the results. If so skip the &lquot;Court
          Hearing&rquot; section. There are a few exceptions such as a paperwork
          ...
          &lquot;General Judgement&rquot;, which we will call the court order,
