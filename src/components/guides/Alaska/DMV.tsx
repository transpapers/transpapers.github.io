...
function AlaskaDMVGuide({ person }: { person: Person }) {
  const { age, isChangingLegalSex, gender } = person;

  return (
    <section key="Alaska-DMV">
      <h3>Updating your Primary ID (AK)</h3>
      <p>
        Even if you do not have a driver's license or ID you still have to notify 
        the DMV in writing that you have changed your legal name. Different DMV 
        offices have different policies regarding this,{" "}
        <a href="https://dmv.alaska.gov/locations/state-dmv-office-locations">here</a>
        {" "}is a list of DMV offices with their contact information. You can 
        call them to ask what their policy is. It does not matter which DMV office 
      ...
      <p>
        ...
        top half of the form, if you are applying for a drivers license/ID for the 
        first time check the “New” box instead of providing a drivers license or 
        ID number. 
        {gender && gender === "X" ? (
          " Alaska does not have an “X” option for ID's, you will need to put either “Male” or “Female” in the top section. "
        ) : ("")}
        Then select what type of ID or drivers license that you would 
        like and answer questions 1 thru 10 on the bottom half of the form. On 
        question 2 though if you have had more names than what we have listed 
        fill in the others. Do <strong>not</strong> sign or date this form with 
        your old legal signature until you are instructed to by a DMV 
        representative. {age && age < 18 && (
      ...
      <p>
        ...
        and then sign it with your old name. Sign and date with your old name as 
      ...
      <p>
        ...
        {isChangingLegalSex && isChangingLegalSex === true ? 
          (" both forms, "):(" the D1 form ")} a certified copy of your court 
        order and payment. Optionally, you may also update your vehicle 
        registration(s). You will be given another form, which you should sign 
        and initial in your new legal name. You will be charged a fee for each 
        vehicle.
      </p>
    </section>
  );
