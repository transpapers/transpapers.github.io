...
function IllinoisChildInfoGuide({ person }: { person: Person }) {
      ...
      <p>
        ...
        {hasCriminalRecord ? (
          <>
            ...
            section 3. Your petitioner cannot file this petition if you have been 
            convicted of a felony and have yet to finish your sentence, including 
            any parole. If box 23 is checked “Yes” your petitioner{" "}
            <strong>needs</strong> to check the “Gender-related identity as 
            defined by the Illinois Human Rights Act” in order to ensure that the 
            petition is still accepted and they will not face felony charges. If 
            there is a hearing expect questions related to your gender identity. 
            They should fill out 2g as needed.
          </>
        ):("")}
        </p>

        <p>
        Moving to section 5 on page 4 your petitioner needs to fill out the other 
        parent information section as it pertains to you.
        {parentsAreOkay ? (
          <>
          ...
          <>
            ...
            count, just have a certified copy of that parental rights termination 
            order ready to submit. A non-petitioning parent should{" "}
            <strong>not</strong> sign this form until a notary instructs them to 
            do so. If you have a guardian or other individual with custody of you 
            then your petitioner needs the “Additional Parent Request for Name 
            Change” (NCM-AP 2006.4) form we attached. Otherwise they can skip it.
          </>
        )}
        If your petitioner cannot get the signature(s) needed then the case will 
        become contested which is beyond the scope of this guide, in that case we 
        strongly recommend getting a lawyer. See the “Resources” section for help 
        with that if needed.
      </p>
    </section>
  );
