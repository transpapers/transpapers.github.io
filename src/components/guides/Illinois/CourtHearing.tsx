...
function IllinoisCourtHearingGuide({ person }: { person: Partial<Person> }) {
  const { age } = person;

  return (
    <section key="IL-CourtHearing">
      <h3>Court Hearing (IL)</h3>
      <p>
...
export default IllinoisCourtHearingGuide;
