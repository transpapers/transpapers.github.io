...
function IllinoisFilingInitialFormsGuide({ person }: { person: Person }) {
  const { age, court, hasCriminalRecord } = person;
  ...
  return (
    <section key="Illinois-Filing">
      ...
      <p>
        ...
        {age && age < 18 ? " your petitioner" : " you"} meets certain criteria. 
        If {age && age < 18 ? " your petitioner wants" : " you want"} to file 
        in-person section 1 of the “Certification for Exemption from E-Filing” 
        (EW-C 3401.4) contains a list of exceptions. If one is applicable then 
        check the appropriate box, otherwise e-filing is required.
      </p>
      ...
      <p>
        ...
        ranges to print. Then go to this{" "}
        <a href="https://efileil.tylertech.cloud/OfsEfsp/ui/landing">
          link
        </a>
        {" "}and click “Register for an Individual Account” from here the 
        state of Illinois provides extensive{" "}
      ...
      <p>
        ...
        immediately. The “Resources” section of this guide can help with that. 
        Provided that there is no hearing and the change is accepted they 
        will return the “Order for Name Change” which we will not call the 
        court order. Make sure to get one or two certified copies for later 
        use and keep the original in a safe place. You are then ready to file 
