...
function IllinoisMinorPetitionGuide({ person }: { person: Person }) {
  ...
  return (
    <section key="Illinois-MinorPetition">
      ...
      <p>
        ...
        {residentLocality} for at least 6 months. This form is already complete 
        unless your petitioner wants to use an alternate address for safety. If 
        so, here is a{" "}
        ...
        {" "}form to fill out, they should also check the appropriate box in 
        the “Sign” section to indicate the altered address.
      </p>
    </section>
  );
}
