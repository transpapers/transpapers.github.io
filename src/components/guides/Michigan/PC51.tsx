...
function MichiganPC51Guide({ person }: { person: Partial<Person> }) {
      ...
      {residentLocality ? (
        <>
          <p>
            ...
            You need to have lived in {residentLocality.name} county for at
            least one year to file this form. If necessary complete item 1 for
          ...
          {age && age < 18 ? (
            <p>
              ...
              and <strong>item 10</strong> as applicable. The parent/guardian
              that is filing this at court should date and sign the bottom of
              page 2 and the left side of the “Signature of Parent/Guardian for
              Minor” section on page 3.
              {parentsAreOkay
        ...
        <p>Could not generate guide, residentLocality missing</p>
      )}
    </section>
  );
}
