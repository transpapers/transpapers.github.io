...
function MichiganPC51Guide({ person }: { person: Person }) {
  ...
  return (
    <section key="Michigan-PC51">
      ...
      cases), <strong>item 8</strong>, and <strong>item 9</strong> (concerning
      criminal record.)
      {age && age < 18 ? (
        <p>
          ...
          at court should date and sign the bottom of pages 2, 3, and complete
          the “Signature of Parent/Guardian for Minor” section on page 4. The
          other should complete the &quot;Consent by Spouse of Petitoner&quot;
          on page 4. If one of your parents is deceased or noncustodial then
          only the first signature is needed. If both are deceased or
          noncustodial your legal guardian should do the above instead and
          attach copies of their letters of guardianship to this form.
          {age && age < 14
