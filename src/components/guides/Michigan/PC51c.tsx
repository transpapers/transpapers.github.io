...
function MichiganPC51cGuide({ person }: { person: Partial<Person> }) {
  ...
  return (
    <section key="Michigan-PC51c">
      ...
      <p>
        ...
        {isChangingLegalSex ? (
          <>
            Anyone changing their name to affirm their gender identity 
            automatically qualifies for this process.
          </>
        ):("")} 
        {" "}You need to have lived in {residentLocalityName ?? ""}{" "}
