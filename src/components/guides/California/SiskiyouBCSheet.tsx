...
function SiskiyouBCGuide({ person }: { person: Partial<Person> }) {
  const { age } = person;

  return (
    <section key="Siskiyou-CV-6">
      <h3>CLETS Background Information Form (Siskiyou county, CV-6)</h3>
      <p>
        Siskiyou county requires that {age && age < 18 ? "you, the minor, " : "you "} 
...
export default SiskiyouBCGuide;
