...
function LosAngelesBCGuide({ person }: { person: Partial<Person> }) {
  const { age } = person;

  return (
    <section key="Los-Angeles-CIV-226">
      <h3>Name Change Criminal History Assessment (Los Angeles county, CIV 226)</h3>
      <p>
...
export default LosAngelesBCGuide;
