...
function CaliforniaCourtHearingGuide({ person }: { person: Partial<Person> }) {
  const { age, residentLocalityName } = person;

  return (
    <section key="CA-CourtHearing">
      <h3>Court Hearing (CA)</h3>
      <p>
      ...
      <ul>
        ...
        <li>Are you a resident of {residentLocalityName} county?</li>
...
export default CaliforniaCourtHearingGuide;
