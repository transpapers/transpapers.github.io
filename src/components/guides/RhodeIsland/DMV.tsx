  ...
  return (
    <section key="RI-DMV">
      ...
      <p>
        ...
        Card and Permit" (LI-1) for changing name and the
        "Gender Designation on a License or Identification Card"
        for changing gender. For the LI-1 form you will
        need to select what type of primary ID you want in the first two
        sections of the "Transaction Type" category. From there review section
      ...
      <p>
        ...
        Social Security. If you selected "REAL ID" you will also need
        an additional document, pick one on page 3 of the LI-1 form
        under "Proof of Identity". It is unusual but not impossible for
        them to ask for Proof of Residency which are also listed on
        page 3 of the LI-1 form. You <strong>don't</strong> need any
        proof or medical records for the gender form.
      </p>

      <p>
        When you {age && age < 18 ? (" and a parent/guardian ") : ("")} arrive,
        tell the clerk that you want to update the name and/or
        gender marker on your ID and present the above documents to
        the clerk. Sign and date both forms in front of the clerk.
        {age && age < 18 ? (
          " A parent/guardian will need to sign the LI-1 form as well just below section G. "
        ) : ("")}
        If you do not already have a driver’s license or state ID, tell
        the clerk that you are applying for one and take the same steps.
        Make sure the gender marker is set correctly before you leave.
        If you experience any issues or pushback politely insist on speaking
        to a manager, they should be more knowledgeable about this process.
        This should cost around $30.00 total.
      </p>
