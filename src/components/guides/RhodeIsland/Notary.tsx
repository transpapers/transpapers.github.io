  ...
  return (
    <section key="RhodeIsland-Notary">
      ...
      {birthJurisdiction && birthJurisdiction == "RI" ? (
        <>
          <p>
            ...
            order made out to the &quot;General Treasurer of RI&quot; for
            $25.00.
            {age && age < 18
              ? " The parent/guardian that is listed on the form will "
              : " You will then "}
            need to make a photocopy of a Drivers License, State ID, or
            Passport. Place the form, photocopy, and payment into an envelope,
            place a stamp, and mail it to:
          </p>
          ...
          <p>
            ...
            <a href="link">
              https://outlook.office365.com/book/VitalRecordsAppointments@health.ri.gov/
            </a>{" "}
            ...
            General&apos;s office is located very close to this address and only
            does walk-ins so it&apos;s possible to knock out both in one trip.
          </p>
        </>
      ) : (
        ""
      ...
      <p>
        ...
        and can be done during the same appointment. Rhode Island maintains a
        list of notaries{" "}
        ...
        <>
          <p>
            ...
            {age && age < 18
              ...
              : " you will "}
            need to make a photocopy of a Drivers License, State ID, or
            Passport. Then have a check or money order for $5.00 made out to
            &quot;BCI&quot;. After that make a self-addressed and stamped
            envelope for them to send the report back in. Finally place the
          ...
          <p>
            ...
            {age && age < 18
              ? " the parent/guardian that is filing these documents at court will "
              : " you will "}
            need to head to the above address. They only do walk-ins so the only
            things needed are a photo ID and a credit/debit card for the $5.00
            fee. They will mail you the report.
          </p>
        </>
      )}
