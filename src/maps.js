...
export const noticeMap = [
    ...
    { text: data => isMinor(data) ? '' : fullName(data.legalName), field: form => form.getField('Petitioners name') },
    { text: data => isMinor(data) ? fullName(representativeName(data)) : '', field: form => form.getField('Petitioners name') },
