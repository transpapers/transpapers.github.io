...
export const piiMap = [
  ...
  { text: (data) => formatDate(data.birthdate, { format: ['month', 'day', 'year'], separator: '/' }), field: 'DOB' },
];
...
export const birthCertMap = [
  {
    text: (data) => (isMinor(data) ? representativeName(data).first : data.chosenName.first),
    loc: { x: 48, y: 196 },
  },
  {
    text: (data) => (isMinor(data) ? representativeName(data).middle : data.chosenName.middle),
    loc: { x: 337, y: 196 },
  },
  {
    text: (data) => (isMinor(data) ? representativeName(data).last : data.chosenName.last),
    loc: { x: 588, y: 196 },
  },
  { text: (data) => data.streetAddress, loc: { x: 48, y: 237 } },
  { text: (data) => `${data.city}, ${data.birthState}`, loc: { x: 388, y: 237 } },
  ...
  { text: (data) => `${data.birthCity}, ${data.birthState}`, loc: { x: 249, y: 636 } },
  { text: (data) => fullName(data.mothersBirthName), loc: { x: 48, y: 710 } },
  { text: (data) => data.mothersBirthdate, loc: { x: 554, y: 710 } },
  { text: (data) => fullName(data.fathersBirthName), loc: { x: 48, y: 754 } },
  { text: (data) => data.fathersBirthdate, loc: { x: 554, y: 754 } },
...
export const ssnMap = [
  ...
  { text: (data) => formatDate(data.birthdate, { format: ['month', 'day', 'year'], separator: '/' }), field: 'topmostSubform[0].Page5[0].DateTimeField1[0]' },
  ...
  { text: (data) => data.residentState, field: 'topmostSubform[0].Page5[0].state[0]' },
...
export const ds5504Map = [
  ...
  { text: (data) => formatDate(data.birthdate, { format: ['month'], separator: '' }), field: 'App DOB MM' },
  { text: (data) => formatDate(data.birthdate, { format: ['day'], separator: '' }), field: 'App DOB DD' },
  { text: (data) => formatDate(data.birthdate, { format: ['year'], separator: '' }), field: 'App DOB YYYY' },
  ...
  { text: (data) => `${data.city} ${data.birthState}`, field: 'App Place of Birth' },
  ...
  { text: (data) => data.residentState, field: 'App Mailing State' },
  { text: (data) => data.zip, field: 'App Mailing Zip' },
  { text: (data) => data.legalName, field: 'App List all other name you have used' },
  { text: (data) => data.legalName, field: 'Your name as printed on your most reent U.S. passport book and/or passport card' },
  { text: (data) => `${data.chosenName.last} ${data.chosenName.first} ${data.chosenName.middle}`, field: 'Name of Applicant 2' },
  { text: (data) => formatDate(data.birthdate, { format: ['month', 'day', 'year'], separator: '/' }), field: 'Date Of Birth' },
...
export const ds82Map = [
  ...
  { text: (data) => data.residentState, field: 'App Mailing Address State' },
  ...
  { text: (data) => formatDate(data.birthdate, { format: ['month', 'day', 'year'], separator: '/' }), field: 'Date Of Birth 2' },
];
...
export const ds11Map = [
  ...
  { text: (data) => formatDate(data.birthdate, { format: ['month'], separator: '' }), field: 'App DOB M' },
  { text: (data) => formatDate(data.birthdate, { format: ['day'], separator: '' }), field: 'App DOB D' },
  { text: (data) => formatDate(data.birthdate, { format: ['year'], separator: '' }), field: 'App DOB Y' },
  { text: (data) => data.gender === 'M', loc: { page: 4, x: 283, y: 298 } },
  { text: (data) => data.gender === 'F', loc: { page: 4, x: 301, y: 298 } },
  { text: (data) => data.gender === 'X', loc: { page: 4, x: 319, y: 298 } },
  { text: (data) => `${data.city} ${data.birthState}`, field: 'Applicant Place of Birth' },
  ...
  { text: (data) => data.birthState, field: 'Applicant Address State' },
  { text: (data) => data.zip, field: 'Applicant Address Zip Code' },
  { text: (data) => data.legalName, field: 'List all other name you have used' },
  { text: (data) => `${data.chosenName.last} ${data.chosenName.first} ${data.chosenName.middle}`, field: 'Name of Applicant 2' },
  { text: (data) => formatDate(data.birthdate, { format: ['month', 'day', 'year'], separator: '/' }), field: 'Applicant DOB 2' },
  ...
  { text: (data) => formatDate(data.mothersBirthdate, { format: ['month', 'day', 'year'], separator: '/' }), field: 'Parent 1 DOB' },
